...
export const createReceivingPoint = async ({ name, address, latitude, longitude }) => {
...
export const deleteReceivingPoint = async (id) => {
...
export const fetchMyReceivingPoints = async () => {
