...
export const Drawer = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      {/* オーバーレイ */}
      {isOpen && <div className="absolute inset-0 bg-black bg-opacity-50 z-40" onClick={onClose}></div>}

      {/* ドロワー */}
      <div
        className={`absolute top-0 right-0 w-64 h-full bg-white z-50 shadow-lg transform transition-transform duration-300 ${
